...
class ArgsHandler:
    ...
    def _get_parser(self):
        ...
        parser.add_argument("--auto_find_batch_size", default=False)
        ...
        parser.add_argument("--neftune_noise_alpha", default=False)
        parser.add_argument("--torch_compile", default=False)
        parser.add_argument("--dataloader_pin_memory", default=False)
        parser.add_argument("--dsconfig", default='../ds_config/ds_config_zero3.json')
    ...
    def _update_args_with_config(self, args, config_from_file):
        ...
        for key, value in config_from_file.items():
            if key == 'accumulation_steps':
                ...
                args_dict[key] = value
        args_dict['accumulation_steps'] = math.ceil(args_dict['batch']/args_dict['per_device_train_batch_size'])
        print('accumulation_steps='+ str(args_dict['accumulation_steps']))
        return args_dict
    ...
    def _create_training_args(self, args_dict):
        training_args = TrainingArguments(
            ...
            neftune_noise_alpha = args_dict['neftune_noise_alpha'],
            torch_compile = args_dict['torch_compile'],
            dataloader_pin_memory = args_dict['dataloader_pin_memory'],
            optim = args_dict['optim'],
            # deepspeed = args_dict['dsconfig']
        )
