...
CONFIG_PATH="test.yaml"  # Configuration for the training setup
URLS_PATH="urls.txt"             # List of URLs for datasets
DEEPSPEED_CONFIG="ds_config_zero2.json"  # DeepSpeed configuration file
