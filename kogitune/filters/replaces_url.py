...
def replace_date(text, replaced='<date>'):
    """
    ...
    """
    return replace_pattern(date_pattern, text, replaced or '<date>')
...
def replace_time(text, replaced=None):
    """
    ...
    """
    return replace_pattern(time_pattern, text, replaced or '<time>')
...
def replace_datetime(text, replaced=None):
    """
    ...
    text = replace_pattern(datetime_pattern, text, replaced or '<date>')
    return text
...
def replace_email(text, replaced=None):
    """
    ...
    """
    text = replace_pattern(email_pattern, text, replaced or '<email>')
    return text
...
def replace_phone(text, replaced=None):
    """
    ...
    """
    text = replace_pattern(phone_pattern, text, replaced or '<phone>')
    return text
